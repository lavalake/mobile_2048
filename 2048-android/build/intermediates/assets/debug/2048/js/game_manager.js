  ...
  traversals.x.forEach(function (x) {
    traversals.y.forEach(function (y) {
      ...
      if (tile) {
        ...
        //hacking
        //if ((next && (next.value === tile.value || next.value*tile.value === 8)
         //&& !next.mergedFrom)) {
        //normal
        ...
        if ((next && (next.value === tile.value)
          ...
          //hacking
          //else
            //var merged = new Tile(positions.next, 8);
          ...
          //console.log(self.score.toString());
          client.printValue(self.score);
          //client.sendToServer(self.score);
          client.writeToFile(self.score);

          // The mighty 2048 tile
          if (merged.value === 2048){
           self.won = true;
           client.printValue(self.score);
           sendToServer(self.score);
          }
        } 
        else {
